...
namespace Homework
{
    class IntercityTruck:Truck
    {
        ...
        public IntercityTruck(int capacity, int maxRPM, int wheelsCount)
        {
        ...
        {
            return "Intercity Truck with " + Capacity + " kg.  Capacity. It has " + WheelsCount + " wheels and currently carries " + CurrentCargo + " kg. cargo.";
        }
    }
}
